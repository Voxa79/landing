...
import { GraduationCap, Zap, Shield, Cpu, Database, Globe, Brain, Users } from "lucide-react";
...
export const UsecaseTrainingPage = () => {
  const features = [
    {
      icon: GraduationCap,
      title: "Parcours Personnalisés",
      description: "Apprentissage adapté au niveau et aux objectifs de chaque apprenant."
    },
    {
      icon: Zap,
      title: "Contenus Générés",
      description: "Création automatique de supports pédagogiques et exercices."
    },
    {
      icon: Shield,
      title: "Suivi Progression",
      description: "Évaluation continue des acquis et recommandations adaptées."
    },
    {
      icon: Brain,
      title: "Tuteurs Virtuels",
      description: "Assistance intelligente pour répondre aux questions en temps réel."
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: "Programmes de mise à jour des compétences pour les professionnels."
    },
    {
      icon: Users,
      title: "Onboarding Employés",
      description: "Intégration efficace des nouveaux collaborateurs avec parcours adaptés."
    },
    {
      icon: Brain,
      title: "Développement Compétences",
      description: "Montée en compétences ciblée sur des domaines spécifiques."
    },
    {
      icon: Globe,
      title: "Formation Multilingue",
      description: "Contenus adaptés pour des apprenants internationaux."
    }
  ];

  const technicalSpecs = [
    { label: "Apprenants", value: "Illimités" },
    { label: "Personnalisation", value: "IA Adaptive" },
    { label: "Suivi", value: "Temps Réel" },
    { label: "Contenus", value: "Générés" },
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            >
              <GraduationCap className="w-10 h-10 text-success filter drop-shadow-[0_0_8px_rgba(234,179,8,0.8)]" />
            ...
            >
              Solution de formation intelligente qui personnalise l'apprentissage et 
              accélère la montée en compétences grâce à des tuteurs virtuels et des contenus adaptatifs.
            </motion.p>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Interface conversationnelle pour les tuteurs virtuels d'apprentissage.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Automatisation des workflows de formation et suivi des apprenants.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base de données pour le stockage des parcours et progression des apprenants.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Intégrez notre solution IA souveraine pour une formation personnalisée et une montée en compétences accélérée.
            </p>
