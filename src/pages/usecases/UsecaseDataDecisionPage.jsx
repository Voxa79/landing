...
import { TrendingUp, Zap, Shield, Cpu, Database, Globe, Brain, BarChart3 } from "lucide-react";
...
export const UsecaseDataDecisionPage = () => {
  const features = [
    {
      icon: TrendingUp,
      title: "Analyse Multi-Sources",
      description: "Agrégation et corrélation de données provenant de multiples sources."
    },
    {
      icon: Zap,
      title: "Recommandations en Temps Réel",
      description: "Suggestions d'actions basées sur l'analyse instantanée des données."
    },
    {
      icon: Shield,
      title: "Modélisation Prédictive",
      description: "Scénarios futurs basés sur les tendances et patterns identifiés."
    },
    {
      icon: Brain,
      title: "Explications Intelligibles",
      description: "Justification claire des recommandations pour une meilleure adoption."
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: "Identification des segments clients et stratégies de ciblage optimales."
    },
    {
      icon: Database,
      title: "Gestion des Risques",
      description: "Évaluation proactive des risques financiers et opérationnels."
    },
    {
      icon: Brain,
      title: "Planification Stratégique",
      description: "Support à la prise de décision pour les orientations à long terme."
    },
    {
      icon: BarChart3,
      title: "Allocation des Ressources",
      description: "Répartition optimale des ressources basée sur les données de performance."
    }
  ];

  const technicalSpecs = [
    { label: "Sources de Données", value: "Illimitées" },
    { label: "Temps de Traitement", value: "< 1s" },
    { label: "Précision", value: "94%" },
    { label: "Explicabilité", value: "IA Intelligible" },
    { label: "Scénarios", value: "Prédictifs" },
    { label: "Intégration", value: "API" }
  ];
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            >
              <TrendingUp className="w-10 h-10 text-action filter drop-shadow-[0_0_8px_rgba(239,68,68,0.8)]" />
            ...
            >
              Solution d'aide à la décision avancée qui transforme vos données en insights 
              actionnables et recommandations précises pour des décisions business optimales.
            </motion.p>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base de données graphe pour modéliser les relations complexes entre données.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base vectorielle pour la recherche sémantique dans les données non structurées.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Modèles LLM pour l'analyse et l'interprétation avancée des données.
                  </p>
                </div>
              </div>
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">
              Prêt à transformer vos décisions business ?
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Intégrez notre solution IA souveraine pour des décisions basées sur des données précises et des insights actionnables.
            </p>
