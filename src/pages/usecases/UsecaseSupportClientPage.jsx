...
import { Headphones, Zap, Shield, Cpu, Database, Globe, Brain, Workflow } from "lucide-react";
import { LocalAIHeader } from '../../components/LocalAIHeader';
import { LocalAIFooter } from '../../components/LocalAIFooter';

export const UsecaseSupportClientPage = () => {
  const features = [
    {
      icon: Headphones,
      title: "Support 24/7",
      description: "Assistance client disponible à tout moment sans interruption."
    },
    {
      icon: Zap,
      title: "Réponses Instantanées",
      description: "Temps de réponse réduit grâce à l'intelligence artificielle."
    },
    {
      icon: Shield,
      title: "Escalade Automatique",
      description: "Transfert intelligent vers des agents humains lorsque nécessaire."
    },
    {
      icon: Brain,
      title: "Personnalisation",
      description: "Réponses adaptées au profil et à l'historique de chaque client."
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: "Assistance pour les questions fréquentes et les problèmes courants."
    },
    {
      icon: Database,
      title: "Gestion des Tickets",
      description: "Classification et routage automatique des demandes de support."
    },
    {
      icon: Brain,
      title: "Analyse des Sentiments",
      description: "Détection de la frustration client pour une intervention proactive."
    },
    {
      icon: Workflow,
      title: "Automatisation des Processus",
      description: "Résolution automatique des problèmes simples sans intervention humaine."
    }
  ];
  ...
  const technicalSpecs = [
    ...
    { label: "Canaux", value: "Multi" },
    { label: "Escalade", value: "Automatique" }
  ];
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            >
              <Headphones className="w-10 h-10 text-success filter drop-shadow-[0_0_8px_rgba(254,185,9,0.8)]" />
            ...
            >
              Solution d'assistance client automatisée disponible 24/7 avec une intelligence 
              artificielle capable de comprendre et résoudre les problèmes des clients en temps réel.
            </motion.p>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Interface conversationnelle pour interagir avec les clients.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Automatisation des workflows de support client.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base de données pour le stockage de l'historique des conversations.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Intégrez notre solution IA souveraine pour une assistance client 24/7 et une satisfaction maximale.
            </p>
