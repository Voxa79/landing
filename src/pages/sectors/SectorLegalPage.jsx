...
import { Scale, Zap, Shield, TrendingUp, FileText, Users, Lock, BarChart3 } from "lucide-react";
...
export const SectorLegalPage = () => {
  const features = [
    {
      icon: FileText,
      title: "RAG juridique sur documents confidentiels",
      description: "Recherche dans les documents juridiques avec respect de la confidentialité."
    },
    {
      icon: Zap,
      title: "Analyse de contrats automatisée",
      description: "Extraction d'informations clés et identification des risques contractuels."
    },
    {
      icon: BarChart3,
      title: "Veille juridique personnalisée",
      description: "Alertes automatiques sur les évolutions législatives pertinentes."
    },
    {
      icon: Shield,
      title: "Génération de clauses légales",
      description: "Création de clauses contractuelles adaptées aux contextes spécifiques."
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: "Extraction automatisée d'informations clés dans les contrats."
    },
    {
      icon: BarChart3,
      title: "Veille juridique",
      description: "Surveillance des évolutions législatives et réglementaires."
    },
    {
      icon: Shield,
      title: "Conformité réglementaire",
      description: "Vérification continue de la conformité aux régulations en vigueur."
    },
    {
      icon: TrendingUp,
      title: "Gestion des litiges",
      description: "Analyse des documents de litige pour identifier les points clés."
    }
  ];

  const technicalSpecs = [
    { label: "Clients Cibles", value: "50-500 employés" },
    { label: "ROI Moyen", value: "320%" },
    { label: "Break-even", value: "6 mois" },
    { label: "Confidentialité", value: "100%" },
    { label: "Précision RAG", value: "95%" },
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            >
              <Scale className="w-10 h-10 text-premium filter drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]" />
              Legal & Conseil
            </motion.h1>
            <motion.p 
            ...
            >
              Solutions d'intelligence artificielle souveraine pour le secteur juridique et du conseil, 
              avec une recherche confidentielle et une analyse automatisée de documents juridiques.
            </motion.p>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Modèles LLM pour l'analyse de documents juridiques.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base vectorielle pour la recherche sémantique dans les documents juridiques.
                  </p>
                </div>
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">
              Prêt à transformer votre cabinet juridique ?
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Intégrez notre solution IA souveraine pour une recherche juridique confidentielle et une automatisation des processus.
            </p>
