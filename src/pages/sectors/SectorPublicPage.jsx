...
import { Landmark, Zap, Shield, TrendingUp, FileText, Users, Lock, BarChart3 } from "lucide-react";
...
export const SectorPublicPage = () => {
  const features = [
    {
      icon: FileText,
      title: "Services numériques souverains",
      description: "Plateformes de services publics hébergées localement avec conformité RGPD/EIDAS."
    },
    {
      icon: Zap,
      title: "Traitement automatisé des demandes",
      description: "Automatisation des processus administratifs avec classification intelligente des demandes."
    },
    {
      icon: BarChart3,
      title: "Assistants pour agents publics",
      description: "Outils d'assistance décisionnelle pour améliorer l'efficacité des agents."
    },
    {
      icon: Shield,
      title: "Archivage sécurisé à long terme",
      description: "Gestion sécurisée des documents administratifs avec conformité aux normes d'archivage."
    }
  ];
  ...
  const useCases = [
    {
      icon: FileText,
      title: "Gestion des dossiers citoyens",
      description: "Automatisation du traitement des dossiers administratifs des citoyens."
    },
    {
      icon: BarChart3,
      title: "Analyse des demandes",
      description: "Classification intelligente et routage automatique des demandes administratives."
    },
    {
      icon: Shield,
      title: "Conformité réglementaire",
      description: "Surveillance continue de la conformité aux régulations administratives."
    },
    {
      icon: TrendingUp,
      title: "Optimisation des processus",
      description: "Analyse des processus pour identifier les améliorations d'efficacité."
    }
  ];

  const technicalSpecs = [
    { label: "Clients Cibles", value: "Toutes administrations" },
    { label: "ROI Moyen", value: "200%" },
    { label: "Break-even", value: "10 mois" },
    { label: "Conformité", value: "RGPD/EIDAS" },
    { label: "Sécurité", value: "Niveau 3" },
    { label: "Épargne Annuelle", value: "€350k+" }
  ];
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            >
              <Landmark className="w-10 h-10 text-sovereign filter drop-shadow-[0_0_8px_rgba(254,185,9,0.8)]" />
            ...
            >
              Solutions d'intelligence artificielle souveraine pour le secteur public et les administrations, 
              avec des services numériques sécurisés et une automatisation des processus administratifs.
            </motion.p>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Modèles LLM pour l'analyse de documents administratifs.
                  </p>
                </div>
                ...
                <div className="p-4 bg-white/10 dark:bg-black/20 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Base vectorielle pour la recherche sémantique dans les documents administratifs.
                  </p>
                </div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Intégrez notre solution IA souveraine pour des services publics numériques et efficaces.
            </p>
